...
const PAYMENT_TIERS_FIELD: TemplateField = {
  key: "paliers_paiement",
  label: "Paliers de paiement",
  type: "textarea",
  placeholder: "Ex : 3 mois à 1 500 €/mois, puis 3 000 €/mois.",
};

const DISCOUNT_FIELD: TemplateField = {
...
const FREE_FIELD: TemplateField = {
  key: "offert",
  label: "Offert / inclus gratuitement",
  type: "textarea",
  placeholder: "Ex : installation offerte, premier mois offert...",
};
...
export const DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        ...PAYMENT_TIERS_FIELD,
        defaultValue: "3 mois à 1 500 €/mois, puis 3 000 €/mois.",
      },
      DISCOUNT_FIELD,
      FREE_FIELD,
      DELAI_FIELD,
